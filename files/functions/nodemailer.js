         ...
         <body>
            <div class="container">
               ...
               <div style="margin: auto; margin-top: 40px; width: 100%;">
                  <a class="verifyLink" href="https://ciwin-react-tickitz-arkademy.netlify.app/verification/${jwtToken}"><div class="verifyBtn">Verifikasi Akun</div></a>
               </div>
            </div>
         </body>
      </html>`
...
exports.resetPassword = (jwtToken, userEmail) => {
   const sendThisMail = {
     from: 'ciwin.tickitz@gmail.com',
     to: userEmail,
     subject: 'Tickitz: Reset Password',
     html:
       `<!DOCTYPE html>
       <html lang="en">
          <head>
