...
// // REDIS - MOVIE TICKET DATA
// exports.removeAllRedisMovieTicketData = (req, res, next) => {
//   console.log("\x1B[31mDelete all movies ticket data from Redis was success!")
//   client.del('redisMovieTicketData')
//   next()
// }
...
// // REDIS - UPCOMING MOVIES
// exports.removeAllRedisUpcomingMovieData = (req, res, next) => {
//   console.log("\x1B[31mDelete all upcoming movies data from Redis was success!")
//   client.del('redisUpcomingMovieData')
//   next()
// }
